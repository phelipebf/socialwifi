...
function init_scraping_db() {
    ...
    $db->exec('CREATE TABLE IF NOT EXISTS user_profile (id INT AUTO_INCREMENT PRIMARY KEY, fb_id INT, name CHAR(255), birthday CHAR (255), age_range CHAR (255))');
}

function save_user_info($params)
{
    $db = Flight::db();
    $stmt = $db->prepare('INSERT INTO user_profile (fb_id, name, birthday) VALUES (:fb_id, :name, :birthday, :age_range)');
